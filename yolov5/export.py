...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default= 'models/dataset.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--keras', default=True,action='store_true', help='TF: use Keras')
